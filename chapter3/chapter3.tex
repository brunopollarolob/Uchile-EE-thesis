...
\begin{enumerate}
    ...
    \item \textbf{Repeating FRBs.} CHARTS will identify new repeaters, share real-time alerts, and enable multi-wavelength follow-ups, essential for calibration and validation of array capabilities.
  \end{enumerate}
...
In summary, CHARTS is designed not only to expand the discovery space for radio transients in the southern hemisphere but also to provide critical insights into the physics of coherent radio emission, the diversity of FRB progenitors, and the dynamic sky of our Galaxy.
