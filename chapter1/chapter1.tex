...
\begin{itemize}
    ...
    \item Chapter 5 presents the testing and validation process for the F-engine, including laboratory experiments and on-sky observations. It details the RFI environment measurement campaign, the correlation tests with multiple antennas, and the solar transit observation. The results are analyzed to assess the performance of the F-engine in terms of phase coherence and data integrity.
