...
The main objective of this work is to design and implement a spectrometer capable of demultiplexing multiple antenna signals over a \SI{200}{\mega\hertz} bandwidth, using the \glspl{adc} of the Xilinx AMD RFSoC 4x2 platform \citep{RealDigital_RFSoC4x2_RefMan_A3}. This constitutes a fundamental component of the CHARTS digital backend, as it allows a single RFSoC board to digitize and compute the Fourier transform (hence the F in F-engine) for up to 32 analog signals from the array of 256 antennas.  
